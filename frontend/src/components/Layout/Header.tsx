        ...
        <div className="flex h-16 items-center justify-between">
          ...
          <div className="hidden md:flex md:items-center md:space-x-4">
            ...
            {cartItemCount > 0 && (
              <Link
                to="/cart"
                className="relative inline-flex items-center px-4 py-2 text-sm font-medium text-[rgb(var(--color-gray-700))] hover:bg-[rgb(var(--color-gray-100))] hover:text-[rgb(var(--color-gray-900))] rounded-[var(--radius-md)] transition-colors duration-[var(--transition-fast)] focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[rgb(var(--color-primary-600))]"
            ...
            <div className="overflow-y-auto h-[calc(100vh-4rem)] pb-safe">
              <nav className="px-4 py-6 space-y-1" aria-label="Mobile navigation">
                ...
                {cartItemCount > 0 && (
                  <Link
                    to="/cart"
                    className="flex items-center justify-between px-4 py-3 text-base font-medium text-[rgb(var(--color-gray-700))] hover:bg-[rgb(var(--color-gray-100))] hover:text-[rgb(var(--color-gray-900))] rounded-[var(--radius-md)] transition-colors duration-[var(--transition-fast)] focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[rgb(var(--color-primary-600))]"
                    aria-label={`Shopping cart with ${cartItemCount} item${cartItemCount !== 1 ? 's' : ''}`}
                  >
                    <span className="flex items-center">
                      <svg
